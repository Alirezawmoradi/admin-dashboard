        ...
        <nav className={`sidebar ${!showSidebar ? 'collapsed' : ''}`}>
            <div className="sidebar-content">
                ...
                <ul className="sidebar-nav pe-0">
                    ...
                    <li className="sidebar-item"><a className="sidebar-link active" href="/" aria-current="page">
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.allCourses')}</span></a></li>
                    <li className="sidebar-item"><a className="sidebar-link" href="/course-categories">
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.coursesCategory')}</span></a>
                    </li>
                    <li className="sidebar-item"><a className="sidebar-link">
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.courseDiscount')}</span></a></li>
                    ...
                    <li className="sidebar-item"><a className="sidebar-link">
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.teacherManagement')}</span></a>
                    </li>
                    <li className="sidebar-item"><a className="sidebar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.studentManagement')}</span></a>
                    </li>
                    ...
                    <li className="sidebar-item"><a className="sidebar-link">
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.tagManagement')}</span></a></li>
                    <li className="sidebar-item"><a className="sidebar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                        ...
                        <span className="align-middle me-2">{t('mainLayout.sidebar.postManagement')}</span></a></li>
                </ul>
            </div>
        </nav>
    )
